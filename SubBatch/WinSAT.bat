...
rem 
rem         Winsat prepop [-datastore <directory>] [ -graphics | -cpu | -mem | -disk
rem  | -dwm ]
rem 
...
set winsat/xml.saveFile="%cd%\WinSAT.REPORT\"
goto winsat/menu
...
if %ERRORLEVEL%==3 goto winsat/test.f
if %ERRORLEVEL%==4 goto winsat/test.d
if %ERRORLEVEL%==5 goto winsat/test.c
if %ERRORLEVEL%==6 goto winsat/test.m
if %ERRORLEVEL%==7 goto winsat/test.3
if %ERRORLEVEL%==8 goto winsat/test.k
if %ERRORLEVEL%==9 goto winsat/test.e
if %ERRORLEVEL%==10 goto winsat/test.a
goto winsat/menu
